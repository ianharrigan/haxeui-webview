...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("", "haxeuiwebview", "haxe.ui.webview.haxeuiwebview", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("haxe.ui.webview.Main");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (haxe.ui.webview.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (haxe.ui.webview.Main, Reflect.field (haxe.ui.webview.Main, "main"), []);
...
@:keep class DocumentClass extends haxe.ui.webview.Main { }
